  ...
  "DataPacketSpec" should {
   ...
   val packet = DataPacket.decode(ALAW_RTP_PACKET_SAMPLE);
    ...
    "testEncode" in {
        ...
        ALAW_RTP_PACKET_SAMPLE must contain theSameElementsInOrderAs(buffer.array())
    }
   ...
   "testEncodeDecode" in {
       ...
       packet.getExtensionData() must contain theSameElementsInOrderAs packet.getExtensionData();
        ...
        packet.getDataAsArray() must contain theSameElementsInOrderAs decoded.getDataAsArray()
    }
//
//    @Test
